...
import { createBankRatio } from "@/lib/actions/bankRatio";
    ...
    return(
      <>
        <button 
           ...
           className="px-4 py-2.5 text-sm font-semibold text-white bg-sky-600 hover:bg-sky-700 rounded-lg shadow-sm transition-colors cursor-pointer disabled:opacity-50">
            + Bank Ratio
        </button>
        ...
        {isOpen &&(
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 space-y-4">
                    <h2 className="text-xl font-bold text-slate-800">Add New Bank Ratio</h2>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <input 
                               ...
                               onChange={(e) => setFormData({ ...formData, capitalAdequacy: e.target.value })}
                               className="w-full border border-slate-300 rounded-lg p-2 text-sm focus:outline-sky-500"
                            />
                          </div>  
                          <div>
                            ...
                            <input 
                               ...
                               onChange={(e) => setFormData({ ...formData, nplRatio: e.target.value })}
                               className="w-full border border-slate-300 rounded-lg p-2 text-sm focus:outline-sky-500"
                            />
                          </div>                       
