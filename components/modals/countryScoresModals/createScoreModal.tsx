...
import { createCountryScore } from "@/lib/actions/countryScores";
...
export default function CreateScoreModal() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await createCountryScore({
        ...
        {isOpen &&(
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 space-y-4">
                    <h2 className="text-xl font-bold text-slate-800">Add New Country Score</h2>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <input 
                               ...
                               onChange={(e) => setFormData({ ...formData, economicScore: e.target.value })}
                               className="w-full border border-slate-300 rounded-lg p-2 text-sm focus:outline-sky-500"
                            />
                          </div>
                          <div>
                            ...
                            <input 
                               ...
                               onChange={(e) => setFormData({ ...formData, politicalScore: e.target.value })}
                               className="w-full border border-slate-300 rounded-lg p-2 text-sm focus:outline-sky-500"
                            />
                          </div>                        
                          <div>
